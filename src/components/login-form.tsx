...
import { Crown, Mail, Lock, Building, User, ArrowLeft } from "lucide-react"
...
export function LoginForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log({ email, password, isOrganization })
  }
    ...
    <div className="w-full max-w-md mx-auto animate-fade-in-up">
      ...
      <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm animate-scale-in">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold bg-gradient-to-r from-[#68EDFF] to-[#5726BF] bg-clip-text text-transparent">
            Welcome Back
          </CardTitle>
          <CardDescription className="text-gray-400">Sign in to your RoyalVente account</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Forgot Password */}
            <div className="text-right animate-fade-in-up" style={{ animationDelay: "500ms" }}>
              <Link
                href="/forgot-password"
                className="text-sm text-[#68EDFF] hover:text-[#5726BF] transition-colors duration-300"
              >
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-[#68EDFF] to-[#5726BF] hover:from-[#5726BF] hover:to-[#68EDFF] text-white font-semibold py-3 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#68EDFF]/25 animate-fade-in-up"
          ...
          {/* Social Login */}
          <div className="grid grid-cols-2 gap-4 animate-fade-in-up" style={{ animationDelay: "800ms" }}>
            <Button
              variant="outline"
          ...
          {/* Sign Up Link */}
          <div className="text-center text-sm text-gray-400 animate-fade-in-up" style={{ animationDelay: "900ms" }}>
